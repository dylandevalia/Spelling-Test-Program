...
Public Class Teacher_Menu_See_Old_Marks_RV
    ...
    Private Sub Load_Report()
        ...
        Dim Class_progress As String = "SELECT * FROM tblMark_info WHERE Class = '" & Teacher_Menu_See_Old_Marks.User_Class & "' AND UserID = '" & Teacher_Menu_See_Old_Marks.User_ID & "' "
        ...
        Me.Class_Progress_Report.Name("Student Progress").ToString()
